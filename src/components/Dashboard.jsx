...
function Dashboard() {
  ...
  const columnDefs = [
    ...
    {headerName: "First_Name", field: "firstName"},
    {headerName: "Last_Name", field: "lastName"},
    {headerName: "Email", field: "email"},
    {headerName: "Department", field: "department"},
    {headerName: "Position", field: "position"},
    {headerName: "Salary", field: "salary",valueFormatter: (s) => `${s.value?.toLocaleString()}`,cellStyle: { fontWeight: "bold", color: "green" }},
    {headerName: "Hire_Date", field: "hireDate"},
    {headerName: "Age", field: "age"},
    {headerName: "Location", field: "location"},
    {headerName: "Rating", field: "performanceRating", cellStyle: (r=>({color:r.value>=4? "green":"orange", fontWeight: "bold"}))},
    {headerName: "Projects_Completed", field: "projectsCompleted"},
    {headerName: "Active", field: "isActive", cellRenderer:(s=>(s.value ? "Active" : "Inactive"))},
    {headerName: "Skills", field: "skills", valueFormatter:(v)=>v.value?.join(", ")},
  ...
  return (
    ...
    <div style={{padding:"20px", background: "white", minHeight: "100vh"}}>
        <h2 style={{marginBottom:"20px", textAlign:"center",color:"black"}}>Employee Dashboard</h2>

        <div className="ag-theme-alpine" style={{height: "85vh", width:"100%", borderRadius: "12px", overflow:"hidden"}}>
            <AgGridReact
            theme={themeQuartz}
